...
<body>
    ...
    <h2>상영관 정보 수정</h2>
    <form action="adTheaterUpdate" method="post">
       <table>
            <tr>
                <td>관고유번호</td>
                <td><input type="text" name="code" value="${theater.theater_code }" readonly="readonly"></td>
            </tr>
            <tr>
                <td>사이트</td>
                <td>
            ...
            <tr>
                <td>관번호</td>
                <td><input type="number" name="num" value="${theater.theater_num}"></td>
            </tr>
            <tr>
                <td>수용인원</td>
                <td><input type="number" name="people" value="${theater.theater_people}"></td>
            </tr>
            <tr>
                <td>종류</td>
                <td>
                	현재 선택중인 상태 : ${theater.theater_kind }
                    <select name="kind" id="">
            ...
            <tr>
                <td colspan="2">
                    <input type="submit" value="상영관 수정">
